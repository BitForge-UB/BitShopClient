 ...
 Task-6_ProducktCard-component
  ...
  return (
    <div className="rounded-lg border-2 border-black shadow-md bg-white fixed bottom-4 right-4 w-96 h-96">
      <button
        className="bg-Button text-white rounded-lg p-2 w-full"
      ...
      ></textarea>
      <button
        className="bg-Button text-white rounded-lg p-2 w-full mt-2 mb-2"
      ...
      <div>
        ...
        <p className="p-4 pt-2">
          {isFetching || !haveSent ? "Svar kommer her" : data}
        </p>
      </div>
    </div>
  );
